...
public class MainActivity extends SwipeRefreshBaseActivity {
    ...
    @Override protected void onPostCreate(Bundle savedInstanceState) {// 调用到onPostCreate时，Activity应该已经 start-up （彻底跑起来）了。
    ...
    private void setupRecyclerView() {
        final StaggeredGridLayoutManager layoutManager = new StaggeredGridLayoutManager(2,// staggered 交错瀑布流效果
